...
void static draw_circle_help(t_data *img, t_circle *data, int x, int y)
{
...
void draw_square(t_data *img, int x, int y, int len_side, int color)
{
    int i;
    int j;
...
void draw_gradient_square(t_data *img, int x, int y, int len_side, int color)
{
    int i;
    int j;

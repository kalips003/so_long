...
void	put_background(t_data2 *data)
{
	int	x;
	int	y;
...
void	put_foreground(t_data2 *data)
{
	int	i;
...
/////////////////////////////////////////////////////////////////////////////////////
static void	ini_anim(t_data2 *data)
{
	char	*path_player;
	char	*path_pika;
	char	*dico;
...
void	ini_texture(t_data2 *data)
{
	...
	data->win = mlx_new_window(data->mlx, data->wid * data->map_x, data->hei
			* data->map_y + 75, "So Looong");
	data->buffer.img = mlx_new_image(data->mlx, data->wid * data->map_x,
			data->hei * data->map_y + 75);
